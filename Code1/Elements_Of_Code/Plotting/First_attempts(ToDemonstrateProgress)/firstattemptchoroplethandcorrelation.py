...
plota=df3.plot(kind='scatter', x='Median Income',y='Total crime')

#Plot to show the relationship between years to purchase a house on  a median income and total crime
plotb=df3.plot(kind='scatter', x='Years to Purchase a House on Median Income',y='Total crime')

#Plot to show the relationship between population density and crime
plotc=df3.plot(kind='scatter', x='Population density',y='Total crime')

#Plot to show the relationship between median income and crime rate
plotd=df3.plot(kind='scatter', x='Median Income',y='Crime Rate')

#Plot to show the relationship between population and crime rate
plote=df3.plot(kind='scatter', x='Population',y='Crime Rate')

#Correlation matrix of variables in df2
corrcoef = df2.corr()

                 #Plot Switches, remove hashtag to try out each plot
#------------------------------------------------------------------------------------------------------------------------
